...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder()
            ...
            .withTags("friends")
            .withSubjects("math")
            .withRelations("Elle Meyer/Alice Pauline/mother/child")
            .build();
    ...
    public static final Person ELLE = new PersonBuilder()
            ...
            .withRelations("Elle Meyer/Alice Pauline/mother/child", "Elle Meyer/Benson Meier/mother/child")
            .build();
    ...
    /**
     * Returns an {@code TutorMap} with all the typical persons.
     */
