...
public class RelateCommandParserTest {
    ...
    private String[] validInput = new String[] {"a\\test/test/test/test", "a\\1/1/1/1 a\\2/2/2/2", "d\\3/3/3/3",
        "d\\4/4/4/4 d\\5/5/5/5 a\\6/6/6/6",
        "    a\\ a  dqwd asd/ awd wd cawf / awefaw  awefsdfweg/sdfw wef    d\\sfwgrtb/  rg wrv/rgfr gree/erfe"};
    private String[] invalidInput = new String[] {"a\\", "d\\", "a\\1", "d\\2/2", "a\\3/3/3", "d\\5/5/5/5/5",
        "na\\test/test/test/test"};
    private String[] extraArgs = new String[] {"n/bruh a\\test/test/test/tes", "a\\1/1/1/1 e/ a\\2/2/2/2", "d\\3/3/3/3",
